...
| Path | Content |
|------|---------|
| `src/docs/specs/YYYY-MM-DD-<topic>-design.md` | Design documents (from brainstorming skill) |
| `src/docs/plans/YYYY-MM-DD-<feature>.md` | Implementation plans (from writing-plans skill) |
| `src/docs/rules/*.md` | Mandatory project constraints (from writing-rules skill) |
| `src/docs/research/` | Research outputs |
| `src/docs/reviews/` | Code review outputs |
