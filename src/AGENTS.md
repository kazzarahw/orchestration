...
- **No inline fixes:** All code changes must be dispatched to a subagent. Direct edits are only allowed for specs (`docs/specs/`), plans (`docs/plans/`), documentation, and configuration files.
